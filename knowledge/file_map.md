...
- [services/routers/demo_hierarchical.py](file:///services/routers/demo_hierarchical.py): +5 read-only endpoints (issue_log #19) — `/discovery-summary`, `/knowledge-gaps`, `/assurance-snapshot`, `/closure-history`, `/traceability-example`.
